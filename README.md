...
This project presents an end-to-end SQL analysis of 100,000+ e-commerce orders from Target’s Brazil operations (2016–2018).
The goal is to uncover insights related to order growth, customer behavior, logistics efficiency, freight costs, and payment patterns, and to provide actionable business recommendations.
